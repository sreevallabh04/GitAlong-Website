    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        {floatingElements.map((element, index) => {
          ...
          >
            <div className="w-16 h-16 bg-[#2ECC71]/20 rounded-full flex items-center justify-center backdrop-blur-sm">
      ...
      {/* Gradient orbs */}
      <div className="absolute top-20 left-20 w-72 h-72 bg-[#2ECC71]/10 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="inline-flex items-center px-4 py-2 bg-[#2ECC71]/20 border border-[#2ECC71] rounded-full text-[#2ECC71] text-sm font-medium mb-8"
        >
        ...
        >
          Match.
          <br />
          <span className="text-[#2ECC71]">Collaborate.</span>
          <br />
          Contribute.
        </motion.h1>
