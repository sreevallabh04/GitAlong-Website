          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center space-x-3 mb-2">
                <Github className="w-6 h-6 text-[#2ECC71]" />
                ...
                {isLoadingReadme ? (
                  <div className="text-center py-12">
                    <div className="inline-flex items-center space-x-2">
                      <div className="w-4 h-4 bg-[#2ECC71] rounded-full animate-bounce"></div>
                      <div className="w-4 h-4 bg-[#2ECC71] rounded-full animate-bounce" style={{ animationDelay: '0.1s' }}></div>
                      <div className="w-4 h-4 bg-[#2ECC71] rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                    </div>
                  ...
                  <div className="space-y-4">
                    {commits.map((commit, index) => (
                      <motion.div
                        ...
                        className="flex items-start space-x-4 p-4 bg-[#21262D] rounded-xl border border-[#30363D] hover:border-[#2ECC71] transition-colors"
                      >
                        <img
